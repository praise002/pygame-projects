...
"""Girl walking left and right. I dont have a standing animation for the girl."""
...
walk_left_flip = [pygame.transform.flip(walk_left[0], True, False),
                  pygame.transform.flip(walk_left[1], True, False),
                  pygame.transform.flip(walk_left[2], True, False),
                  pygame.transform.flip(walk_left[3], True, False),
                  pygame.transform.flip(walk_left[4], True, False),
                  pygame.transform.flip(walk_left[5], True, False),
                  pygame.transform.flip(walk_left[6], True, False),
                  pygame.transform.flip(walk_left[7], True, False),
                  pygame.transform.flip(walk_left[8], True, False),
                  pygame.transform.flip(walk_left[9], True, False)]

#testing walk_left
# walk_left = pygame.image.load("images_girl/walk1.png").convert_alpha()
# walk_left = pygame.transform.flip(walk_left, True, False)  #surf,flip_x,flip_y(boolean)
# walk_left_rect = walk_left.get_rect()
# walk_left_rect.topleft = (100, 200)
...
def redraw_screen():
    ...
    if right:
        ...
        screen.blit(walk_left_flip[walk_count // 3], (x, y))
        walk_count += 1
    else:
        walk_count = 0
...
while True:
    ...
    redraw_screen()
    # screen.blit(walk_left, walk_left_rect)
    pygame.display.flip()
    clock.tick(60)
